...
# new alert integrating with rashi code
...
def fun1111():
    ...
    if(0<=x<100 and 60<=y<85 and 20<=z<50):
        pass
    else:
        msg = Message('IOT Alert', sender='kaustubdutt@gmailcom', recipients=['rashikaur6@gmail.com'])
        msg.body = "Dear Customer,\n\nYour environmental conditions are exceed than optimal at time.\n\nTemperture   Normal Range(25,34) \nHumidity        Normal Range(60,85) \nSoil Moisture   Normal Range(20,50).\n\nPlease Take necesary precautions to avoid further damage to your Crop\n\nThanks and Regards,\nManohar Reddy"
        mail.send(msg)
    return "hello"
